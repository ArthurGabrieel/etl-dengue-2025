...
CREATE TABLE dw.DIM_PAC (
    ...
    COD_DEM VARCHAR(150) NOT NULL UNIQUE,
    DES_FAI_ETA VARCHAR(30) NOT NULL,
    DES_SEX VARCHAR(20) NOT NULL,
    DES_RAC VARCHAR(30) NOT NULL,
    DES_ESC VARCHAR(50) NOT NULL,
    DES_FAI_ETA_DET VARCHAR(50) NOT NULL
);

-- Registro UNKNOWN
INSERT INTO dw.DIM_PAC (PAC_SRK, COD_DEM, DES_FAI_ETA, DES_SEX, DES_RAC, DES_ESC, DES_FAI_ETA_DET)
